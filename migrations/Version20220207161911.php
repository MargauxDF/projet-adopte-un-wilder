 ...
 */
final class Version20220207161911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_adopted TINYINT(1) DEFAULT NULL');
    }
